...
print("                                         ****************************************************************************")
print("                                         *                                                                          *")
print("                                         *                   WELCOME TO HOSPITAL DATA HANDLING                      *")
print("                                         *                                                                          *")
print("                                         ****************************************************************************")
...
while tries_flag != "Close the program" :
		...
		if Admin_user_mode == "1" :																			#Admin mode
				...
				while True :
					...
					if Password == "****" :
						print("-----------------------------------------")
						print("|To manage patients data Enter 1 	|	|\n|To manage docotrs data Enter 2	 	|\n|To manage appointments Enter 3 	|\n|To be back Enter E			|")
						print("-----------------------------------------")
						...
						if AdminOptions == "1" :															#Admin mode --> Pateints Management
								print("-----------------------------------------")
								print("|To add new patient data Enter 1	  	|")
								print("|To display patient data Enter 2	  	|")
							...
							print("|To display doctor data Enter 2         |")
